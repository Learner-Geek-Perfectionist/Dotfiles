...
echo '$HOME/clipboard.zsh'
echo '$HOME/completion.zsh'
echo '$HOME/grep.zsh'
echo '$HOME/key-bindings.zsh'
echo '$HOME/directories.zsh'
echo '$HOME/history.zsh'
echo '$HOME/theme-and-appearance.zsh'
echo '$HOME/git.zsh'
